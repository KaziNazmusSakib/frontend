...
export default function SellerLoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      const response = await authAPI.seller.login(data)
...
<div className="mx-auto w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mb-6">
...
<p className="text-sm text-gray-600">
                ...
                New to our platform?{' '}
<Link href="/seller/register" className="font-medium text-success hover:text-success/80">
